...
class BME280:
    ...
    def __init__(self, bus_n):
        ...
        h_samp = 0x00 #skipp humidity mesurement
        p_samp = 0x03 #2 oversampling
        t_samp = 0x00 #skipp temperature mesurement

        self.get_cal_param()
        self.set_power_mode(power_mode['BME280_NORMAL_MODE'])
        self.set_oversamp_humidity(h_samp)
        self.set_oversamp_pressure(p_samp)
        self.set_oversamp_temperature(t_samp)
        time.sleep(0.01)
        self.t_fine = 0.0
        #print("config_reg", self.config_reg)
        #print("ctrl_meas_reg", self.ctrl_meas_reg)
        #print("ctrl_hum_reg", self.ctrl_hum_reg)
        #print("oversamp_humidity", self.oversamp_humidity)
        #print("oversamp_pressure", self.oversamp_pressure)
